...
class Third3ViewController: UIViewController {
    ...
    @IBOutlet weak var AppendWord15: UITextField!
    @IBOutlet weak var AppendWord16: UITextField!
    ...
    @IBAction func ButtonClicked(sender: AnyObject) {
        ...
        Word15 = AppendWord15.text
        Word16 = AppendWord16.text
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        fourthViewController.wordString.append("\(Word15!)")
        fourthViewController.wordString.append("\(Word16!)")
